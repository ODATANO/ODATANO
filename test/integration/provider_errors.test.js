...
describe('Provider error handling (integration) - input validation against running server', () => {
  ...
  test('Metadata missing tx -> 400', async () => {
    // call the Metadata entity without tx param (service should return 400)
    await request(BASE)
      .get('/Metadata')
      .expect(400);
  });
