...
- **Total Tests**: 1921 (full run with all backends reachable; the Ogmios-dependent suites skip otherwise). Per-file counts further down predate the v2.0 additions and are indicative, not authoritative.
