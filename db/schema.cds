...
entity Blocks {
    ...
    epoch: Association to Epochs on epoch.epoch = $self.epochNumber;
...
entity Addresses: temporal {
    ...
    utxos: Composition of many AddressUTxOs on utxos.address = $self;
...
entity AddressUTxOs : temporal {
    ...
    assets    : Composition of many UTxOAssets on assets.utxo = $self;
...
entity Accounts: temporal {
    ...
    Address: Composition of many Addresses on Address.stakeAddress = $self.stakeAddress;
...
entity Transactions {
    ...
    metadata: Composition of many TransactionMetadata on metadata.tx = $self;

    @title: 'Transaction Inputs'
    @description: 'The transaction inputs composition'
    inputs: Composition of many TransactionInputs on inputs.tx = $self;

    @title: 'Transaction Outputs'
    @description: 'The transaction outputs composition'
    outputs: Composition of many TransactionOutputs on outputs.tx = $self;
...
entity TransactionInputs {
    ...
    assets: Composition of many TransactionInputAssets on assets.input = $self;
...
entity TransactionOutputs {
    ...
    assets: Composition of many TransactionOutputAssets on assets.output = $self;
...
entity TransactionBuilds : temporal {
    ...
    inputs: Composition of many TransactionBuildInputs on inputs.build = $self;

    @title: 'Build Outputs'
    @description: 'The outputs created in the transaction build'
    outputs: Composition of many TransactionBuildOutputs on outputs.build = $self;

    @title: 'Associated Submission'
    @description: 'Association to the transaction submission if submitted'
    submission: Association to one TransactionSubmissions on submission.build = $self;
...
entity TransactionBuildInputs {
    ...
    assets: Composition of many TransactionBuildInputAssets on assets.input = $self;
...
entity TransactionBuildOutputs {
    ...
    assets: Composition of many TransactionBuildOutputAssets on assets.output = $self;
...
entity TransactionSubmissions : temporal {
    ...
    errors: Composition of many TransactionSubmissionErrors on errors.submission = $self;
